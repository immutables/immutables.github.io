...
_Alternatively, and recommended going forward, you can register custom annotations using the [`-Aimmutables.annotation`](/newandnice.html#-aimmutablesannotation) annotation processor option without creating a META-INF file._
...
<div class="headsup">
At last! There's a [Reference of all styles](/allstyles.html)
</div>
