...
Overview
--------
> **Important:** While we don't yet deprecate mongo repositories, new and existing users are encouraged to consider [criteria API](criteria.html) as a better alternative
...
- <a href={`${depUri}/mongo/${v}/jar`}>org.immutables:mongo:{v}</a>
