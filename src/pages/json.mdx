...
JSON is a simple and flexible format. Moreover, using libraries like [Jackson](http://wiki.fasterxml.com/JacksonHome), you can use various additional [textual](https://github.com/FasterXML/jackson-dataformats-text) and [binary](https://github.com/FasterXML/jackson-dataformats-binary) formats
(BSON, Smile, CBOR, yaml etc.)
...
<div class="headsup">
  See section about newly added Jackson 3 support in [New & Nice!](/newandnice.html#jackson3)
</div>

_Jackson_ doesn't require any serious code generation to be flexible and highly performant
...
- See style option [`setJacksonPropertyRequired`](/allstyles.html#setJacksonPropertyRequired)
- See style option [`forceJacksonIgnoreFields`](/allstyles.html#forceJacksonIgnoreFields)
...
- <a href={`${depUri}/gson/${v}/jar`}>org.immutables:gson:{v}</a>
