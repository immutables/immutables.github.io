...
final class ImmutableTuple
  ...
  public static ImmutableTuple of(int index, String name) {
    return precondition(new ImmutableTuple(index, name));
  }

  private static ImmutableTuple precondition(ImmutableTuple instance) {
    return instance;
  }
}
```

By default more stuff is generated, but a you could see, those extras could be disabled
(see [Style guide](/style.html) for examples of how to do this using meta-annotation).
Here's more typical example:
...
final class ImmutableValueObject
  ...
  private final Optional<java.lang.String> comment;
  ...
  private ImmutableValueObject(
      ...
      Optional<java.lang.String> comment,
      long[] data) {
    this.id = id;
    this.name = name;
  ...
  public final ImmutableValueObject withId(long value) {
    ...
    long newValue = value;
    return precondition(new ImmutableValueObject(
        this,
        newValue,
        this.name,
        this.numbers,
   ...
   * @return modified copy of the {@code this} object
   */
  public final ImmutableValueObject withName(java.lang.String value) {
    if (this.name == value) {
      return this;
    }
    java.lang.String newValue = Preconditions.checkNotNull(value);
    return precondition(new ImmutableValueObject(
        this,
        this.id,
        newValue,
   ...
   * @return modified copy of {@code this} object
   */
  public final ImmutableValueObject withComment(java.lang.String value) {
    Optional<java.lang.String> newValue = Optional.of(value);
    return precondition(new ImmutableValueObject(
        this,
        this.id,
        this.name,
   ...
   * @return modified copy of {@code this} object
   */
  public final ImmutableValueObject withComment(Optional<java.lang.String> optional) {
    if (this.comment == optional) {
      return this;
    }
    Optional<java.lang.String> newValue = Preconditions.checkNotNull(optional);
    return precondition(new ImmutableValueObject(
        this,
        this.id,
        this.name,
  ...
  private static ImmutableValueObject precondition(ImmutableValueObject instance) {
    return instance;
  }
  ...
  static final class Builder {
    ...
    private long id;
    private @Nullable java.lang.String name;
    private ImmutableList.Builder<Number> numbersBuilder = ImmutableList.builder();
    private Optional<java.lang.String> comment = Optional.absent();
    ...
    public final Builder from(ValueObject instance) {
      ...
      Optional<java.lang.String> commentOptional = instance.comment();
     ...
     * @return {@code this} builder for chained invocation
     */
    public final Builder comment(Optional<java.lang.String> comment) {
    ...
    public ImmutableValueObject build() {
      ...
      return ImmutableValueObject.precondition(new ImmutableValueObject(this));
    }
