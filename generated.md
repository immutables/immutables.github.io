...
Let's start with minimal example. Generation of builder and copy methods is disabled,
and there are no Guava or JSR-305 annotations libraries in classpath.
...
See the [Style guide](/style.html) for examples of how to do this using meta-annotations.
