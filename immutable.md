...
with `org.immutable.annotation.GenerateImmutable` annotation. May contain [attributes](#attributes) and other meta-data, as well as regular java methods (and fields if needed). It is strongly recommended to not introduce
