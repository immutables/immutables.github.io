...
but in addition we employ effective API style popularized by "Effectice Java, Second Edition" book and Guava Library.
We also rigorously prohibit usage of `null` as attribute values ([Using and avoiding null explained](https://code.google.com/p/guava-libraries/wiki/UsingAndAvoidingNullExplained)).
...
Other aspect of modelling is representatation of system state and domain entities as sequences of _events_ or _snapshots_.
...
model for generated code. [Getting started guide](/gettingstarted.html)
...
This requires nothing special from _Immutables_, just use [default attributes](#default-attributes)
